...
const technologies = [
  ...
  {
    id: "thermal",
    title: "ATTO640D-04W Thermal Camera",
    subtitle: "Military-grade thermal in a micro package",
    description:
      "The Lynred ATTO640D-04W is a 640\u00D7480 uncooled microbolometer with 12\u00B5m pixel pitch and less than 35mK NETD (Noise Equivalent Temperature Difference). Manufactured in Grenoble, France, it provides the same thermal sensitivity found in systems 100\u00D7 heavier. A germanium window ensures optimal IR transmission across the 8\u201314\u00B5m LWIR band.",
    specs: [
      ...
      { label: "Manufacturer", value: "Lynred, Grenoble, France" },
  ...
  },
  {
    ...
    subtitle: "Dual-source EU-first energy",
    description:
      "The B1 Scout uses a dual-source battery strategy. Primary: LeydenJar Silyte silicon anodes (Netherlands) with CUSTOMCELLS assembly (Germany) delivering approximately 390 Wh/kg and 975mAh at just 1.9g \u2014 100% EU supply chain. Fallback: Amprius SiCore (USA) at 450 Wh/kg and 1125mAh for the same weight. Firmware auto-detects the installed cell via OCV and internal resistance profiling.",
    specs: [
      { label: "Primary (EU)", value: "LeydenJar + CUSTOMCELLS" },
      { label: "EU Capacity", value: "975mAh @ 1.9g" },
      { label: "EU Energy Density", value: "~390 Wh/kg" },
      { label: "Fallback (US)", value: "Amprius SiCore" },
      { label: "US Capacity", value: "1125mAh @ 1.9g" },
      { label: "Auto-Detect", value: "OCV + IR profiling" },
    ],
  },
  {
    id: "pcb",
    ...
    description:
      "All electronics are integrated onto a single 4-layer PCB manufactured by Eurocircuits (Belgium). The board hosts an STM32H743VIT6 flight controller, Nordic nRF5340 communications SoC, STSAFE-A110 secure element, power management, and sensor interfaces \u2014 all in a footprint smaller than a postage stamp. EU component content exceeds 90% by cost.",
    specs: [
      { label: "Layers", value: "4-layer FR4" },
      { label: "MCU", value: "STM32H743VIT6 (480MHz)" },
      { label: "Comms", value: "nRF5340 + nRF7002 (BLE/WiFi)" },
      { label: "Security", value: "STSAFE-A110 (CC EAL5+)" },
      { label: "Manufacturer", value: "Eurocircuits, Belgium" },
