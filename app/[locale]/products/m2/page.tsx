...
const copy = {
  it: {
    ...
    features: [
      { icon: "\u2708\uFE0F", title: "Ala fissa ad alta efficienza", description: "Design aerodinamico ad alta efficienza che massimizza portata e autonomia. Struttura biomimetica in fibra di carbonio, leggera e resistente." },
      { icon: "\uD83D\uDD0B", title: "Propulsione elettrica", description: "Propulsione elettrica a batteria con pacchi sostituibili a caldo per la persistenza. Nessuna emissione, bassa rumorosita, operativita in qualsiasi condizione." },
    ...
    specs: [
      { label: "Tipo", value: "Ala fissa ad alta efficienza" },
      { label: "Taglie", value: "S / M / L / XL" },
      { label: "Apertura alare", value: "1.5m \u2014 8m (a seconda della taglia)" },
      { label: "Alimentazione", value: "Elettrica a batteria (hot-swap)" },
    ...
    faq: [
      { question: "Quanto vola l'M2?", answer: "L'autonomia dipende dalla taglia e dalla configurazione. Grazie all'architettura efficiente e ai pacchi batteria sostituibili a caldo, l'M2 e progettato per voli di ore, non minuti. I dettagli esatti saranno comunicati con il lancio del prodotto." },
      ...
      { question: "Perche elettrico a batteria?", answer: "La propulsione elettrica a batteria offre semplicita, sovranita e nessuna logistica di rifornimento speciale. I pacchi sostituibili a caldo permettono missioni in sequenza con tempi di fermo minimi." },
  ...
  en: {
    ...
    features: [
      { icon: "\u2708\uFE0F", title: "High-efficiency fixed wing", description: "High-efficiency aerodynamic design that maximises range and endurance. Biomimetic carbon fibre structure, lightweight and resilient." },
      { icon: "\uD83D\uDD0B", title: "Battery-electric propulsion", description: "Battery-electric propulsion with hot-swap packs for persistence. Zero emissions, low noise, operational in any conditions." },
    ...
    specs: [
      { label: "Type", value: "High-efficiency fixed wing" },
      { label: "Sizes", value: "S / M / L / XL" },
      { label: "Wingspan", value: "1.5m \u2014 8m (depending on size)" },
      { label: "Power", value: "Battery-electric (hot-swap)" },
    ...
    faq: [
      { question: "How long does the M2 fly?", answer: "Endurance depends on size and configuration. Thanks to the efficient airframe and hot-swap battery packs, the M2 is designed for flights lasting hours, not minutes. Exact figures will be shared at product launch." },
      ...
      { question: "Why battery-electric?", answer: "Battery-electric propulsion offers simplicity, sovereignty and no special refuelling logistics. Hot-swap packs enable back-to-back missions with minimal downtime." },
...
export function generateMetadata({ params }: { params: { locale: string } }): Metadata {
  ...
  return {
    ...
    description: isIt
      ? "UAV ad ala fissa elettrico a batteria. Centinaia di km per missione. 4 taglie. Progettato in Europa."
      : "Battery-electric fixed-wing UAV. Hundreds of km per mission. 4 sizes. Designed in Europe.",
  };
}
