...
const variantData: Record<string, VariantData> = {
  guard: {
    ...
    features: [
      ...
      { icon: "\ud83c\udf0c", title: "Day/Night Vision", description: "640x480 thermal + visible light fusion provides 24/7 coverage regardless of lighting or weather conditions." },
    ],
    specs: [
    ...
    <>
      ...
      <section className="section-container py-20">
        <div className="glass-card text-center py-12">
          ...
          <Link href={`${prefix}/pre-order`} className="btn-primary">
