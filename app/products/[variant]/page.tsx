...
const variantData: Record<string, VariantData> = {
  guard: {
    ...
    features: [
      ...
      { icon: "\u{1F30C}", title: "Day/Night Vision", description: "1024x768 XGA thermal + visible light fusion provides 24/7 coverage regardless of lighting or weather conditions." },
    ],
    specs: [
      ...
      { label: "Thermal Sensor", value: "1024x768 XGA Uncooled Thermal (<40mK)" },
  ...
  cine: {
    ...
    faq: [
      { question: "What video quality can I expect?", answer: "The thermal sensor outputs 1024x768 XGA at 60fps. The visible light camera streams 1080p. Both feeds can be recorded simultaneously to microSD with metadata overlay." },
