...
const variantData: Record<string, VariantData> = {
  guard: {
    ...
    features: [
      { icon: "\u{1F441}", title: "Perch & Stare", description: "86 hours of continuous monitoring from a fixed position. Wakes on motion, conserving power for days of unattended operation." },
      { icon: "\u{1F6A8}", title: "AI Intrusion Alert", description: "On-device person/vehicle classification triggers instant alerts to your phone or command center via encrypted mesh." },
      { icon: "\u{1F30C}", title: "Day/Night Vision", description: "640x480 thermal + visible light fusion provides 24/7 coverage regardless of lighting or weather conditions." },
    ],
    specs: [
      { label: "Weight", value: "36.1g" },
      { label: "Wingspan", value: "120mm (deployed)" },
      { label: "Propulsion", value: "PZT Bimorph + EDF 20mm" },
      { label: "Flight Endurance", value: "45min hover / 60min cruise" },
      { label: "Perch Endurance", value: "86 hours" },
      { label: "Thermal Sensor", value: "Lynred ATTO640D-04W" },
      ...
      { label: "Battery", value: "LeydenJar / Amprius SiCore" },
      { label: "Charging", value: "Magnetic pogo dock" },
      { label: "Comms", value: "BLE 5.3 + LTE-M" },
    ...
    faq: [
      ...
      { question: "What is the detection range?", answer: "The ATTO640D thermal sensor can detect a person at up to 200m in clear conditions, and a vehicle at up to 500m. Performance varies with environmental conditions." },
  ...
  inspect: {
    ...
    features: [
      { icon: "\u{1F3D7}", title: "Structural Analysis", description: "Thermal gradient mapping identifies delamination, moisture ingress, and stress fractures in concrete and steel structures." },
      { icon: "\u{1F4CA}", title: "Report Generation", description: "Automated inspection reports with geo-tagged thermal maps, anomaly classification, and severity scoring." },
      { icon: "\u{1F3AF}", title: "Precision Navigation", description: "Waypoint-based autonomous flight paths ensure consistent, repeatable inspection coverage every time." },
    ],
    specs: [
      { label: "Weight", value: "36.1g" },
      { label: "Wingspan", value: "120mm (deployed)" },
    ...
    faq: [
      ...
      { question: "Can it inspect in confined spaces?", answer: "Yes. At 36.1g with a 120mm wingspan, it can navigate through openings as small as 200mm, making it ideal for interior inspections of tanks, tunnels, and ducts." },
    ],
  },
  rescue: {
    name: "B1 Rescue",
    ...
    features: [
      { icon: "\u{1F9D1}\u200D\u{1F692}", title: "Person Detection", description: "AI-powered thermal person detection works through smoke, dust, darkness, and light foliage. Classifies prone, standing, and moving targets." },
      { icon: "\u{1F4CD}", title: "GPS Marking", description: "One-tap GPS marking of survivor locations, shared in real-time with all rescue team members via encrypted mesh network." },
  ...
  agri: {
    ...
    features: [
      { icon: "\u{1F33F}", title: "Crop Health Mapping", description: "Thermal NDVI analysis detects water stress, nutrient deficiency, and disease onset up to two weeks before visible symptoms appear." },
      { icon: "\u{1F4F1}", title: "Farm Dashboard", description: "Cloud-based field maps with historical comparison, zone-level health scoring, and actionable recommendations." },
      { icon: "\u{1F504}", title: "Autonomous Patrol", description: "Define field boundaries once, then the B1 Agri flies optimized survey patterns automatically on a schedule you set." },
    ],
    specs: [
      { label: "Weight", value: "36.1g" },
      { label: "Wingspan", value: "120mm (deployed)" },
      ...
      { label: "Speed", value: "35 km/h cruise" },
      { label: "Range", value: "2 km round-trip" },
      { label: "Battery", value: "LeydenJar / Amprius SiCore" },
    ...
    faq: [
      ...
      { question: "What about pesticide spraying?", answer: "The B1 Agri is a monitoring platform, not a sprayer. At 36.1g it cannot carry payloads. It identifies where to spray, reducing chemical use by up to 40% through targeted application." },
    ],
  },
  cine: {
    name: "B1 Cine",
    ...
    features: [
      { icon: "\u{1F3AC}", title: "Cinematic Modes", description: "Pre-programmed flight paths including orbit, dolly, and reveal. Smooth stabilized footage with 3-axis EIS." },
      { icon: "\u{1F989}", title: "Wildlife Safe", description: "Inaudible to most wildlife at operating altitude. No rotor wash disturbs foliage or animals. Thermal for night shoots." },
      { icon: "\u{1F4F7}", title: "Dual Imaging", description: "Switch between visible and thermal in-flight. Picture-in-picture mode overlays thermal on visible for dramatic effect." },
    ],
    specs: [
      { label: "Weight", value: "36.1g" },
      { label: "Wingspan", value: "120mm (deployed)" },
    ...
    faq: [
      { question: "What video quality can I expect?", answer: "The thermal sensor outputs 640x480 at 30fps. The visible light camera streams 1080p. Both feeds can be recorded simultaneously to microSD with metadata overlay." },
...
export default function ProductPage({ params }: { params: { variant: string } }) {
  const data = variantData[params.variant];
  if (!data) notFound();
