...
const variantData: Record<string, VariantData> = {
  guard: {
    ...
    features: [
      ...
      { icon: "\u{1F30C}", title: "Day/Night Vision", description: "High-resolution thermal + visible light fusion provides 24/7 coverage regardless of lighting or weather conditions." },
    ],
    specs: [
